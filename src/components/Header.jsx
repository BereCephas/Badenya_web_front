  ...
  return (
    <div className="shadow-md w-full fixed h-15 z-30 ">
      <div className="md:flex items-center justify-between bg-marron py-4  2xl:px-40 md:px-20 px-10">
        ...
        {/* link items */}
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-marron md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
          ...
          {Links.map(
            (
              ...
              <li key={index} className="md:ml-8 md:my-0 my-7 font-semibold">
                <a
                  href={link.link}
                  className="text-beige hover:text-blue-400 duration-500  lg:text-2xl 2xl:text-3xl"
                >
                  {link.name}
                </a>
              </li>
